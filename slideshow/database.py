...
def get_rnd_db_entries(N=5):
    ...
    if max_id is not None:
        if max_id < N:
            ...
            ids = np.random.choice(np.arange(1, max_id + 1), replace=True, size=N)
